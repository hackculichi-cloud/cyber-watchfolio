  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden grid-bg">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        <p className="text-muted-foreground max-w-xl mx-auto mb-8 text-sm md:text-base animate-fade-in-up delay-300">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 animate-fade-in-up delay-400">
          ...
          <Button variant="neon-outline" size="lg" asChild>
            <a href="/resume.pdf" download="Christian-Velasco-SOC-Analyst.pdf">
